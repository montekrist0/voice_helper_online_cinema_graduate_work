...
import psycopg2
from db.connection_handler import PostgreConnError, connect_db, create_elastic_connection, create_redis_connection
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    logging.exception(
                        f'Extraction failed. Database connection closed: \n\t {db_error}. '
