...
@backoff.on_exception(
    wait_gen=backoff.expo, exception=redis_exceptions.ConnectionError, on_backoff=redis_conn_backoff_hdlr, max_tries=10
)
...
@backoff.on_exception(
    wait_gen=backoff.expo, exception=ElasticConnectionError, on_backoff=elastic_conn_backoff_hdlr, max_tries=10
)
