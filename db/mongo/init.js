...
db.to_be_removed.insertOne(
    {text: ["мне", "каком", "каких", "какой",
            ...
            "кто", "как", "много", "количество", "назови",
        ]},
);
...
db.commands.insertOne(
    {
        ...
        how_many_films: ["фильмов выпустил автор", "фильмов выпустил", "выпустил",
            "создал", "выпустил фильм", "создал фильм",
        ...
        top_films: ["топ десять фильмов", "топ десять фильмов", "кинохиты",
            "лучшие фильмы", "топ фильмы", "топ", "топ десять"],

        top_films_genre: ["топ десять фильмов в жанре", "топ десять в жанре", "топ в жанре"],
